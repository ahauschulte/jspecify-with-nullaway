/**
 * This package contains classes that demonstrate the use of JSpecify annotations
 * in conjunction with NullAway to enforce null-safety in Java applications.
 *
